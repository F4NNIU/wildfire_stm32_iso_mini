...
extern TESTING_STATE testing_state;
//extern void touch_process (void);					//mp3
//extern void touch_process_fm (void);			//fm
extern void touch_process_boardtest (void);//测板程序
extern void even_process_boardtest(void);
...
{ 
  ...
  {	
    touch_flag=1;
		if(testing_state==SB_MP3)
		{
		//	touch_process();
		}
		else if(testing_state == SB_FM)
		{
		//	touch_process_fm();
		}
		else
		{
			touch_process_boardtest();
			even_process_boardtest();
