...
#elif 1
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOE, GPIO_Pin_6)
#define NRF_CSN_LOW()       GPIO_ResetBits(GPIOE, GPIO_Pin_6)		        //csn置低
#define NRF_CE_HIGH()	      GPIO_SetBits(GPIOE,GPIO_Pin_5)
#define NRF_CE_LOW()	      GPIO_ResetBits(GPIOE,GPIO_Pin_5)			      //CE置低
#define NRF_Read_IRQ()		  GPIO_ReadInputDataBit ( GPIOC, GPIO_Pin_4)  //中断引脚
#endif
